...
import (
	...
	"github.com/derhabicht/planning-tools/internal/fp"
)

// BaseVersion is the SemVer-formatted string that defines the current version of fp.
...
func main() {
	fp.RootCmd.Version = fmt.Sprintf(
		"%s+%s.%s.%s",
		BaseVersion,
		GitBranch,
		GitRevision,
